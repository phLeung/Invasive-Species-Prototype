...
<body>
    ...
    <div class="split">
        ...
        <div class="login">
            ...
            <br>
            <form style="margin-left:20px" action="login/loguserin.php" method="post">
                <!--Username-->
                ...
                <br>
                <a href="login/passReset/forgotpassword.php">Forgot Password?</a>
                <br>
                <br>
        ...
        <div class="signup">
                ...
                <br>
                <!--Username-->
                <form style="margin-left: 20px" action="login/register.php" method="post">
