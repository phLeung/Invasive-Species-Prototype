...
<body>
    ...
    <?php include 'cardEditing/cardInfo.php';?>
    ...
    <div style="margin-left:10px" class="addCard col col-md-6">
            <br>
            <h1 style="font-family:Coustard; background-color: #f1f1f1">Add a Card</h1>
            <br>
            <form action="cardEditing/addCard.php" method="post">
                <!--Descript-->
		...
		<br>
                ...
                <br />
		<br>
                <button type="submit" class="btn btn-primary btn-success" id="add">Add Card</button>
            </form>
        </div>
        <br>
<div style="margin-left:-10px;" class="deleteCard col col-md-6">
<br>
            <h1 style="font-family:Coustard;background-color: #f1f1f1">Delete a Card</h1>
            <br>
            <form action="cardEditing/confirmDelete1.php" method="post">
                ...
                <br>
                <br>
                <button type="submit" class="btn btn-primary btn-success" id="delete">Delete Card</button>
            </form>
